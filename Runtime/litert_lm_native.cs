...
internal static class litert_lm_native
{
    ...
    internal static extern int create_engine(string model_path, int numThreads, int batchSize, bool clearCacheOnPrefill, int benchmarkDecodeTokenCount, out IntPtr engine);


    [DllImport(name, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    internal static extern int create_session(IntPtr engine, out IntPtr out_session, ref SamplingParams sessionParams);
    ...
    [DllImport(name, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    internal static extern void generate_text_async(string input, IntPtr session,
